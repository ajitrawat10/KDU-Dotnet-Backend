...
namespace Assignment_2
{
    ...
    {
        static List<Assignment_2.Models.Coins> coinsList;
        static List<Assignment_2.Models.Transaction> transactionList;
        static List<Assignment_2.Models.Traders> traderList;
        static List<Assignment_2.Models.Traders> traderPortfolioList = new List<Traders>();
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                coinsList = File.ReadAllLines("D:\\KDU\\KDU-Dotnet-Backend\\Assignment-2\\Files\\coins.csv")
                                        .Skip(1)
            ...
            try
            {
                traderList = File.ReadAllLines("D:\\KDU\\KDU-Dotnet-Backend\\Assignment-2\\Files\\traders.csv")
                                       .Skip(1)
            ...
            try
            {
                ...
                string filename = @"D:\\KDU\\KDU-Dotnet-Backend\\Assignment-2\\Files\\test_transaction.json";
